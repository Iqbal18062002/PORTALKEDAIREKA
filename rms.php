...
<head>
    ...
    <script src="https://kit.fontawesome.com/4d66db882f.js" crossorigin="anonymous"></script>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="font-family:monr;font-size:18px"><i class="fa-solid fa-circle-user"></i>
            ...
            $row = mysqli_fetch_assoc($sql);
                ?>
                    <li class="dw">
                         <a href="" data-toggle="modal" data-target="#new_user" style="font-family:monr;font-size:18px"><i class="fa fa-user"></i> Profile</a>
                    </li>
                   <li class="divider"></li>
                        ...
                        <li class="dw">
                            <a href="logout.php" style="font-family:monr;font-size:18px"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                        </li>
                    </ul>
                </li>
            </ul>
...
?>
    ...
    ?>
      ...
      <div class="col-sm-3" style="float:none">  
              <input type="hidden" class="form-control ans" name="id" value="<?php echo $row['USER_ID'] ?>" >
        
        <input type="text" class="form-control ans" id="fname" name="fname" value="<?php echo $row['FIRSTNAME'] ?>" >
      </div>
    </div> 
    <div class="form-group">
      <label class="control-label col-sm-1" for="lname">Lastname:</label>
      <div class="col-sm-3" style="float:none">          
        <input type="text" class="form-control ans" id="lname" name="lname" value="<?php echo $row['LASTNAME'] ?>" >
      </div>
    </div>  
    <div class="form-group thn">
      <label class="control-label col-sm-1" for="user" style="text-align:left">User:</label>
      <div class="col-sm-3" style="float:none">          
        <input type="text" class="form-control ans" id="user" name="user" value="<?php echo $row['USER'] ?>" >
      </div>
    </div>    
    <div class="form-group thn">
      <label class="control-label col-sm-1" for="pwd">Password:</label>
      <div class="col-sm-3" style="float:none">          
        <input type="password" class="form-control ans" id="pwd" name="pwd" value="<?php echo $row['PASSWORD'] ?>" >
      </div>
    </div>
    <div class="form-group thn">
      <label class="control-label col-sm-2" for="pwd" style="text-align:left">User Type</label>
      <div class="col-sm-3" style="float:none">   
        <select class="form-control ans" name="type" id="sel1">
    ...
    <?php } ?>
    <div class="form-group">
      <label class="control-label col-sm-2" for="admin" style="text-align:left">Current Password</label>
      <div class="col-sm-3" style="float:none">          
        <input type="password" class="form-control ans" name="admin" required="">
      </div>
    </div> 
      ...
      <div class="modal fade" id="s_report" role="dialog">
                ...
                <div class="modal-content">
                    ...
                    <form action="rms.php?page=list_report" method="POST">
                      ...
                      <br><br>
                      <div class="col-sm-2">          
                       <select class="form-control ans" name="sy" id="pd">
                        <option></option>
                        <?php
                        include 'db.php';
                    ...
                    <div class="form-group">
                      ...
                      <br><br>
                      <div class="col-sm-2">   
                        <select class="form-control ans" name="stats" id="w">
                        <option ></option>
                    ...
                    <div class="modal-footer">
                      <input type="submit" class="btn st_edit" name="submitb" value="View">
                      </form>
                      
                          <button type="button" class="btn st_edit" data-dismiss="modal">Cancel</button>
                    </div>
                </div>
                </div>
                 </div>
