      ...
      <div class="alert alert-success" id="correct"> Student is now removed from Candidate of Promotion!</div>
       ...
       <div class="panel panel-default">
        ...
        <button style="float:right; margin-top:20px;" class="btn st_tambah" data-toggle="modal" data-target="#myModal" type="submit"><i class="fa-solid fa-circle-xmark fa-lg" style="color:#7E0000"></i> Edit</button> 
          <h3 class="panel-title st_judul">Students List</h3>
        </div> 
...
<div class="modal fade" id="myModal" role="dialog">
        ...
        <div class="modal-content">
          ...
          <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title" id="">Ubah Status Promote</h4>
          </div>
          <div class="modal-body">
              <form class="" method="post">
                <input type="hidden" id="" name="id">
                <div class="form-group">
                  <h4>Apa anda yakin melakukan perubahan ini?</h4>
  
                  <div class="modal-footer" style="border:0px; margin-top:20px;">
                   
                    <button type="submit" class="btn st_edit">Ya</button>
                       <button type="button" class="btn st_edit" data-dismiss="modal">Tidak</button>  
                   </div> 
