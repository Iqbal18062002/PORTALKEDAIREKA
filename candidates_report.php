    ...
    #stud{
      ...
      top:0px;
		...
		#stud{
          ...
          <div class="container st_main">
          <button type="text" class="btn st_edit" onclick="printContent('stud')" >PRINT</button>
		...
		<br> <br>
       <div class="col-md-8" id="stud" style="padding:30px">   
	...
	<tr>
		...
		<td style="width:800px;font-size:20px;line-height:5mm;text-align:center;" >
  ...
  <table id="students" class="table table-bordeeless" style="margin-top:30px" >
    <thead>
      <tr id="heads" style="text-align:center">
        <td style="width:20%">Nama</th>
        <td style="width:10%">Kurikulum</th>
