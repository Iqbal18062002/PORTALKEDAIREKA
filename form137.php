...
<div class="col-md-2" id="head">
	<button class="btn st_edit" onclick="print()">PRINT</button>
	<a class="btn st_edit" onclick="window.close()">Cancel</a>
...
<div style="margin-left:.5in;margin-right:.5in;margin-top:.1in;margin-bottom:.1in;line-height:1mm;">
		...
		<p><center><b>Student Grading System</b></center></p>
		  ...
		  <div class="row">
		  <div class="col-md-12">
		  <center><p><b><h4>RAPOR HARUM SENTOSA BARU</h4></b></p></center>
		  </div>
          </div>
          <div class="row">
		  <div class="col-md-12">
