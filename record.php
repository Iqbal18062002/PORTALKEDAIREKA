...
success:function(data)
{
   ...
   .brd td, .brd th {
    ...
    ?>
      ...
      <a href="rms.php?page=record&id=<?php  echo $_GET['id']?>" class="btn st_edit"> View All</a>
    ...
    while($sy = mysqli_fetch_assoc($query)){ ?>
      <a class='btn st_edit' href="rms.php?page=addrecord&id=<?php echo $_GET['id'] ?>&sy=<?php echo $sy['school_year'] ?>&prog=<?php echo $_GET['prog'] ?>"><i class="fa fa-plus"> Add Record</i></a>
      <?php
    } ?>
    </div>
    <br>
 ...
 <?php
  ...
  <div class="row">
   ...
   <br><br>
    ...
    <div class="col-xs-12">
      <table class="table brd" style="width:940px" >
