<!--$("#rowws").clone().appendTo("#table-body").show();-->
    ...
    <style>
      .ans2 tr td input, .ans2 tr td select, .tbody tr td input{
        border : 0px;
...
?>
     ...
     <div class="col-md-6">
       ...
       <div class="col-md-6">
         <input type="text" name="school" class="form-control ans" id ="school" value="School" required>
       </div>
       </div>
       <br>
       <div class="row">
       ...
       <div class="col-md-6">
         <select type="text" name="yr" class="form-control ans" id ="yr" required>
        <?php 
       include 'db.php';
       $id = $_GET['id'];
       ...
       <div class="col-md-6">
         <input type="text" name="sec" class="form-control ans" id ="sec"required>
       </div>
       </div>
       <br>
       <div class="row">
       ...
       ?>
         <input type="text" name="tny" class="form-control ans" id ="" value="<?php echo $srow['TOTAL_NO_OF_YEARS']+1 ?>" readonly>
          <?php }else{ ?>
          <input type="text" name="tny" class="form-control ans" id ="" value="<?php echo $trow['TOTAL_NO_OF_YEAR']+1 ?>" readonly>
            <?php
            } ?>
       </div>
       </div>
       ...
       <div class="col-md-6">
         <input type="text" name="sy" class="form-control ans" id ="sy" value="<?php echo $_GET['sy'] ?>"  >
       </div>
       </div>
       <br>
       ...
       <div class="col-md-6">
         <input type="text" name="class" class="form-control ans" id ="" readonly="">
       </div>
       </div>
     </div>
     <div class="col-md-6">
       ...
       <div class="col-md-6">
         <input type="text" name="au" class="form-control ans" id ="au" >
       </div>
       </div>
       <br>
       <div class="row">
       ...
       <div class="col-md-6">
         <input type="text" name="lu" class="form-control ans" id ="lu" >
       </div>
       </div>
       <br>
       <div id="en_adv">
       ...
       <div class="col-md-6">
         <input type="text" name="adviser" class="form-control ans" id ="adviser" >
       </div>
       </div>
       </div>
       <br>
       ...
       <div class="col-md-6">
         <input type="text" name="rank" class="form-control ans" id ="ra" >
       </div>
       </div>
        <br>
     </div>
     ...
     <br>
       <table class="table-borderless">
         ...
         <tbody id="table-body" class="ans2 tbody">
         <?php
          for($i =0 ; $i<1; $i++){
          ?>
...
?>
     ...
     <button class="btn st_edit" type="submit" style="margin-top:7px;">Save</button>
     </div>
